...
do --[[gathering]]--
	...
	-- wide chests
	aadd("z-gathering-1",					"merge-chest-selector",																"f")
	
	-- Storage Tank
	aadd("z-gathering-3",					"storage-tank2",																			"b")
	...
	aadd("z-gathering-8",					"omega-drill",																				"g")
	aadd("z-gathering-8",					"deep-mine",																					"h")
	aadd("z-gathering-8",					"deep-mine-2",																				"i")
	...
	-- waterwell
	aadd("z-gathering-9",					"water-well-pump",																		"b")
	
	-- stone waterwell
	aadd("z-gathering-9",					"stone-waterwell",																		"b")
	
	-- aquifer drill
	aadd("z-gathering-9",					"aquifer-drill",																			"c")
...
do --[[production]]--
	...
	if z_balance.other_mini and i_exist("mini-assembler-1") then
		ahide("electric-furnace",			"mini-furnace-1")
		if i_exist("green-transport-belt") and i_exist("rapid-transport-belt-mk1") then 
			...
			ahide("assembling-machine-6",		"mini-assembler-6")
			ahide("oil-refinery",					"mini-refinery")
			--[[switch_tech("electric-furnace-2")
			switch_tech("electric-furnace-mk2")
			switch_tech("electric-furnace-3")
			switch_tech("electric-furnace-mk3")
			switch_tech("assembling-machine-mk4")
			switch_tech("assembling-machine-mk5")
			switch_tech("assembling-machine-1")
			switch_tech("assembling-machine-2")
			switch_tech("assembling-machine-3")
			switch_tech("assembling-machine-4")
			switch_tech("assembling-machine-5")
			switch_tech("assembling-machine-6")--]]
		elseif i_exist("green-transport-belt") then
			...
			ahide("assembling-machine-6",		"mini-assembler-6")
			ahide("oil-refinery",					"mini-refinery")
			--[[switch_tech("electric-furnace-1")
			switch_tech("electric-furnace-2")
			switch_tech("assembling-machine-1")
			switch_tech("assembling-machine-2")
			switch_tech("assembling-machine-3")
	...
	-- air filter
	aadd("z-production-16",				"air-filter-machine",																	"a")
	aadd("z-production-16",				"air-filter-machine-mk2",															"b")
	aadd("z-production-16",				"air-filter-machine-mk3",															"c")
	
	-- aai industry
	aadd("z-production-17",				"fuel-processor",																			"c")
	aadd("z-production-17",				"burner-assembling-machine",													"c")
	aadd("z-production-17",				"bob-distillery",																			"c")
...
do --[[resources]]--
	...
	-- deep mining
	aadd("z-resources-7",					"deep-mining",																				"a")
...
do --[[chemistry]]--
	...
	aadd("z-chemistry-2",					"specialized-refining-heavy-oil",											"f")
	aadd("z-chemistry-2",					"specialized-refining-light-oil",											"g")
	aadd("z-chemistry-2",					"specialized-refining-petroleum",											"h")
...
do --[[transport]]--
	...
	aadd("z-transport-1",					"faster-loader",																			"d")
	aadd("z-transport-1",					"purple-loader",																			"e")
	aadd("z-transport-1",					"extremely-fast-loader",															"e")
  if i_exist("faster-loader") and i_exist("green-loader") then
	...
	-- belt sorter
	aadd("z-transport-1",					"belt-sorter1",																				"i")
	aadd("z-transport-1",					"belt-sorter2",																				"j")
	aadd("z-transport-1",					"belt-sorter3",																				"k")
	
	-- smart splitter
	aadd("z-transport-2",					"subterranean-belt",																	"h")
	aadd("z-transport-2",					"fast-subterranean-belt",															"i")
	aadd("z-transport-2",					"express-subterranean-belt",													"j")
	aadd("z-transport-2",					"smartsplitter",																			"k")
	...
	-- subterrain
	aadd("z-transport-11",				"subterranean-pipe",																	"k")
	...
	-- personal teleporter
	aadd("z-transport-17",				"Teleporter_Beacon",																	"a")

	-- teleportation
	aadd("z-transport-17",				"teleportation-beacon",																"b")
...
do --[[energy]]--
	-- aai industry
	aadd("z-energy-1",						"electric-boiler",																		"f")
	aadd("z-energy-1",						"fat-boiler",																					"g")
	
	aadd("z-energy-2",						"rotary-motion-engine",																"f")
	
	aadd("z-energy-3",						"burner-turbine",																			"f")
	
	aadd("z-energy-8",						"art-fusion-reactor",																	"a")
	...
	-- AAI Industry
	aadd("z-energy-11",						"small-iron-electric-pole",														"k")
	...
	-- rail power system
	aadd("z-energy-11",						"rail-electric-pole",																	"l")
...
do --[[defense]]--
	-- natural evolution
	aadd("z-defense-0",						"ne-living-wall",																			"i")
	aadd("z-defense-0",						"ne-living-wall-refresh",															"j")
	aadd("z-defense-0",						"ne-living-wall-exhausted",														"k")
	
	-- dectorio
	aadd("z-defense-0",						"dect-wood-wall",																			"a")
	aadd("z-defense-0",						"dect-chain-wall",																		"b")
	aadd("z-defense-0",						"dect-concrete-wall",																	"e")
	aadd("z-defense-0",						"concrete-wall",																			"f")
	
	aadd("z-defense-1",						"dect-hazard-gate",																		"d")
	
	-- reinforced walls
	aadd("z-defense-0",						"acid-resist-wall",																		"g")
	aadd("z-defense-0",						"damage-reflect-wall",																"h")
...
do --[[intermediate]]--
	...
	aadd("z-intermediate-7",			"alien-artifact",																			"y")
	aadd("z-intermediate-7",			"small-alien-artifact",																"z")
	...
	-- aai industry
	aadd("z-intermediate-6",			"stone-tablet",																				"n")
	aadd("z-intermediate-6",			"motor",																							"o")
	aadd("z-intermediate-6",			"electric-motor",																			"p")
...
do --[[trains-vehicles]]--
	...
	aadd("z-trains-0",						"bi-rail-wood-bridge",																"e")
	
	-- smart trains
	aadd("z-trains-0",						"smart-train-stop",																		"j")
	
	-- rail power system
	aadd("z-trains-0",						"powered-rail",																				"e")
	aadd("z-trains-1",						"hybrid-train",																				"p")
	...
	-- vehicle wagon
	aadd("z-vehicles-1",					"winch",																							"j")
	
	-- aai
	aadd("z-vehicles-1",					"vehicle-warden",																			"h")
	aadd("z-vehicles-1",					"vehicle-chaingunner",																"i")
	...
	aadd("z-vehicles-3",					"vehicle-flame-tank",																	"i")
	
	-- electric trains
	aadd("z-trains-1",						"electric-locomotive",																"h")
	aadd("z-trains-1",						"electric-locomotive-mk2",														"i")
	aadd("z-trains-1",						"electric-locomotive-mk3",														"j")
	...
	-- electric vehicles
	aadd("z-trains-1",						"electric-vehicles-electric-locomotive",							"k")
	aadd("z-vehicles-0",					"electric-vehicles-electric-tank",										"f")
	aadd("z-vehicles-1",					"electric-vehicles-electric-car",											"g")
	
	-- vehicle wagon
	aadd("z-trains-1",						"vehicle-wagon",																			"p")
	
	-- diesel locomotive
	aadd("z-trains-2",						"fluid-locomotive",																		"k")
	
	-- fusion train
	aadd("z-trains-1",						"fusion-locomotive",																	"q")
end
do --[[armor]]--
	...
	-- train caller
	aadd("z-armor-24",						"trainCallerEquipment",																"e")
			
	-- portal research
	aadd("z-armor-7",							"personal-microwave-antenna-equipment",								"i")
end
do --[[weaponry]]--
	-- explosive termites
	...
	-- AAI Vehicles Warden
	aadd("z-weaponry-1",					"electroshock-pulse-ammo",														"i")
	...
	aadd("z-weaponry-7",					"bio_land_mine",																			"g")
end
do --[[decorative]]--
	-- landfill
	...
	-- dectorio
	aadd("z-decorative-0",				"dect-base-water",																		"c")
	aadd("z-decorative-0",				"dect-base-water-green",															"d")
	aadd("z-decorative-0",				"dect-base-dirt",																			"e")
	aadd("z-decorative-0",				"dect-base-sand",																			"f")
	aadd("z-decorative-0",				"dect-base-sand-dark",																"g")
	aadd("z-decorative-0",				"dect-base-grass",																		"h")
	aadd("z-decorative-0",				"dect-base-grass-dry",																"i")
	aadd("z-decorative-0",				"dect-base-red-desert",																"j")
	aadd("z-decorative-0",				"dect-base-red-desert-dark",													"k")
	
	aadd("z-decorative-1",				"dect-paint-hazard",																	"l")
	aadd("z-decorative-1",				"dect-paint-emergency",																"m")
	aadd("z-decorative-1",				"dect-paint-radiation",																"n")
	aadd("z-decorative-1",				"dect-paint-safety",																	"o")
	aadd("z-decorative-1",				"dect-paint-danger",																	"p")
	aadd("z-decorative-1",				"dect-paint-caution",																	"q")
	aadd("z-decorative-1",				"dect-paint-defect",																	"r")
	aadd("z-decorative-1",				"dect-paint-operations",															"s")
	...
	-- natural evolution
	aadd("z-decorative-2",				"decelerate_concrete",																"k")
end
do --[[alien]]--
	-- natural evolution
...
do  --[[misc]]--
	-- quarry
	_log("ZGroupChange Quarry ")
	for a, b in pairs(data.raw["recipe"]) do
		if (not (b == nil)) then
			if (type(b) == "table") then
				for c, d in pairs(b) do
					_log(b.name.."------>"..tostring(c).."-->"..tostring(d))
				end
			else
				_log(b.name)
			end
			if (not (b.category == nil)) then
				_log("------>category-->"..b.category)
				if (b.category == "fuel-processing") then
					aadd("z-intermediate-6"                 , b.name                                   ,   "z["..b.name.."]")
				elseif (b.category == "quarry") then
					aadd("z-resources-7"                    , b.name                                   ,   "z["..b.name.."]")
					--ihide(b.name)
					--rhide(b.name)
				end
			end
