...
do --[[gathering]]--
	...
	aadd("z-gathering-10",       "y-water-gen",                  "f")
	aadd("z-gathering-10",       "y-water-gen-e",                "g")
	aadd("z-gathering-10",       "y-water-gen-recipe-e",         "h")
	aadd("z-gathering-10",       "y_water_mixer",                "i")
...
do --[[liquids]]--
	if allow_changes and data.raw.fluid["lithia-water"] and mods.yuoki then
		data:extend({
			{
...
do --[[defense]]--
	...
	if allow_changes and mods.yuoki then
		ahide("radar-4")
		ahide("radar-5")
...
do --[[parts]]--
	if mods.yuoki then zgc.add_main_group("parts") end
...
do --[[youki]]--
	if mods.yuoki then zgc.add_main_group("youki") end
...
do --[[TECH]]--
	if z_balance.youki_tech and mods.yuoki then
