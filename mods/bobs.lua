...
do	--[[gathering]]--
	...
	aadd("z-gathering-9",		"water-pump",								"d")
	aadd("z-gathering-9",		"water-pump-2",							"e")
	aadd("z-gathering-9",		"water-pump-3",							"f")
	aadd("z-gathering-9",		"water-pump-4",							"g")
	aadd("z-gathering-9",		"water-pump-5",							"h")
	
	aadd("z-gathering-10",	"water-miner-1",						"a")
	aadd("z-gathering-10",	"water-miner-2",						"b")
	aadd("z-gathering-10",	"water-miner-3",						"c")
	aadd("z-gathering-10",	"water-miner-4",						"d")
	aadd("z-gathering-10",	"water-miner-5",						"e")
	
	aadd("z-gathering-11",	"bob-pump-2",								"b")
	aadd("z-gathering-11",	"bob-pump-3",								"d")
	aadd("z-gathering-11",	"bob-pump-4",								"e")
	aadd("z-gathering-11",	"void-pump",								"f")
	
	aadd("z-gathering-12",	"pumpjack",									"a")
	aadd("z-gathering-12",	"bob-pumpjack-1",						"b")
	aadd("z-gathering-12",	"bob-pumpjack-2",						"c")
	aadd("z-gathering-12",	"bob-pumpjack-3",						"e")
	aadd("z-gathering-12",	"bob-pumpjack-4",						"f")
	
	aadd("z-gathering-13",	"air-pump",									"a")
	aadd("z-gathering-13",	"air-pump-1",								"b")
	aadd("z-gathering-13",	"air-pump-2",								"c")
	aadd("z-gathering-13",	"air-pump-3",								"d")
	aadd("z-gathering-13",	"air-pump-4",								"e")
	aadd("z-gathering-13",	"air-pump-5",								"f")
  ...
  if i_exist("5d-mining-drill-speed-1") and i_exist("bob-mining-drill-1") and allow_changes then
	...
	if mods.bobs and allow_changes then ahide("electric-mining-drill") end
end
do	--[[production]]--
  ...
  if i_not_exist("5d-chemical-plant-2") and allow_changes then
...
do	--[[defense]]--
	aadd("z-defense-0",		"reinforced-wall",										"c")
...
do	--[[trains-vehicles]]--
	aadd("z-trains-1",			"bob-locomotive-2",							"b")
	aadd("z-trains-1",			"bob-locomotive-3",							"d")
	aadd("z-trains-1",			"bob-armoured-locomotive",			"f")
	aadd("z-trains-1",			"bob-armoured-locomotive-2",		"g")
	
	aadd("z-trains-2",			"bob-cargo-wagon-2",						"b")
	aadd("z-trains-2",			"bob-cargo-wagon-3",						"d")
	aadd("z-trains-2",			"bob-armoured-cargo-wagon",			"f")
	aadd("z-trains-2",			"bob-armoured-cargo-wagon-2",		"g")
	aadd("z-trains-2",			"bob-armoured-cargo-wagon-3",		"h")
	
	aadd("z-trains-3",			"bob-fluid-wagon-2",						"b")
	aadd("z-trains-3",			"bob-fluid-wagon-3",						"d")
	aadd("z-trains-3",			"bob-armoured-fluid-wagon",			"f")
	aadd("z-trains-3",			"bob-armoured-fluid-wagon-2",		"g")
